    ...
    <div className="w-full bg-white overflow-x-hidden">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center p-4 md:px-20 gap-4">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 font-semibold text-center text-gray-700">
          ...
          <span className="hover:text-black cursor-pointer">Terms & Condition</span>
      ...
      <div className="px-4 md:px-20 py-6 space-y-4 text-center">
        ...
        <div className="border-b-2 border-gray-200 pb-2">
          <h1 className="font-bold text-2xl md:text-3xl">Terms & Conditions</h1>
        </div>
      </div>
      ...
      <div className="w-full px-4 md:px-20 py-6 space-y-10 text-justify text-gray-800">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold">3. Acceptance of Terms</h2>
          <p>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-2">
            <h3 className="font-semibold text-lg">4.1 Eligibility</h3>
            <p>
          ...
          {/* 4.2 User Accounts */}
          <div className="space-y-2">
            <h3 className="font-semibold text-lg">4.2 User Accounts</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-semibold text-lg">4.3 Prohibited Activities</h3>
            <p>You agree not to use Dudumsg for any unlawful or prohibited activities, including:</p>
         ...
         {/* 5. Use of Services */}
         <section className="space-y-6">
          <h2 className="text-xl font-bold">5. Content Ownership and Responsibility</h2>

          {/* 5.1 Eligibility */}
          <div className="space-y-2">
            <h3 className="font-semibold text-lg">5.1  Your Content</h3>
            <p>
          ...
          {/* 5.2 User Accounts */}
          <div className="space-y-2">
            <h3 className="font-semibold text-lg">5.2  Responsibility for Content</h3>
            <p>
...
{/* 6. Use of Services */}
<section className="space-y-6">
          <h2 className="text-xl font-bold">6. Payment and Subscription</h2>

          {/* 6.1 Eligibility */}
          <div className="space-y-2">
            <h3 className="font-semibold text-lg">6.1  Fees</h3>
            <p>
          ...
          {/* 6.2 User Accounts */}
          <div className="space-y-2">
            <h3 className="font-semibold text-lg">6.2  Payment Information</h3>
            <p>
...
<section className="space-y-6">
          ...
          <div className="space-y-2">
            <h3 className="font-semibold text-lg">7.1 Termination by You</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-semibold text-lg">7.2  Termination by Dudumsg</h3>
            <p>
