...
function Home () {
  ...
  <div className="flex justify-between items-center">
    ...
    <div className="flex items-center space-x-2">
      <img src="./img/file.png" alt="logo" className="w-16 h-16 object-contain" />
      <h3 className="text-lg font-bold">
        <img src='./img/lohogo.png' className="w-28" alt='logoname' />
      </h3>
    </div>
    ...
    <div className="hidden md:flex items-center space-x-6 text-sm">
      ...
      <div className="relative">
        <button
          ...
          className="cursor-pointer hover:text-red-400 hover:underline focus:outline-none"
          style={{ fontSize: "16px", color: "grey" }}
        >
          Features
        </button>
        {isFeaturesOpen && (
          <div className="absolute left-0 top-full mt-1 flex flex-col bg-white shadow-lg rounded-md min-w-[150px] z-50">
            <Link to="/feature" className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 whitespace-nowrap">Feature</Link>
            <Link to="/education" className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 whitespace-nowrap">Education</Link>
          </div>
        )}
      </div>

      <h5 className="cursor-pointer hover:text-red-400 hover:underline">
        <Link to="/pricing" style={{ textDecoration: "none", color: "grey", fontSize: "16px" }}>Pricing</Link>
      </h5>
    ...
    <div className="hidden md:flex items-center space-x-4 font-bold">
      <h5 className="cursor-pointer" ><Link to='/signin'style={{ fontSize: "16px", color: "grey","textDecoration":"none" }}> Sign In</Link></h5>
      <button
  type="button"
  className="border border-red-500 px-4 py-1 text-green-500 rounded-lg hover:bg-red-500 hover:text-white transition"
>
  <Link 
    to="/signuppage" 
      ...
      <div className="w-full flex flex-col items-center">
        ...
        {isFeaturesOpen && (
          <div className="mt-2 w-full flex flex-col items-center space-y-2">
            <Link to="/feature" className="text-sm text-gray-700 hover:underline">Feature</Link>
            <Link to="/education" className="text-sm text-gray-700 hover:underline">Education</Link>
          </div>
        )}
      </div>

      <h5 className="cursor-pointer hover:text-red-400 hover:underline">
        <Link to="/pricing" style={{ color: "grey", fontSize: "16px" }}>Pricing</Link>
      </h5>
